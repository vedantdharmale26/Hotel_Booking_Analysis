...
### 1️⃣ Data Collection
Hotel booking dataset (CSV) containing information about:
- Hotel type  
- Booking status  
- Lead time  
- Country  
...
- Inserted cleaned data using Python  
...
Compared city vs resort hotel performance
